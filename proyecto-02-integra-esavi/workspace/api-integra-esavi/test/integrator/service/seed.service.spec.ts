...
import { SeedService } from 'src/integrator/service/seed.service';
...
import { Canton } from 'src/integrator/entity/canton.entity';
...
import { CausalidadEsavi } from 'src/integrator/entity/causalidad-esavi.entity';
import { DatoEsavi } from 'src/integrator/entity/dato-esavi.entity';
import { DatoVacuna } from 'src/integrator/entity/dato-vacuna.entity';
import { DatoVacunacion } from 'src/integrator/entity/dato-vacunacion.entity';
import { DesenlaceEsavi } from 'src/integrator/entity/desenlace-esavi.entity';
import { GravedadEsavi } from 'src/integrator/entity/gravedad-esavi.entity';
import { Medicamento } from 'src/integrator/entity/medicamento.entity';
import { Notificacion } from 'src/integrator/entity/notificacion.entity';
import { Paciente } from 'src/integrator/entity/paciente.entity';
import { Parametro } from 'src/integrator/entity/parametro.entity';
import { Parroquia } from 'src/integrator/entity/parroquia.entity';
import { Provincia } from 'src/integrator/entity/provincia.entity';
import { Vacunometro } from 'src/integrator/entity/vacunometro.entity';
import { PARAMETROS_POR_DEFECTO } from 'src/integrator/constants/parametros-por-defecto';
...
jest.mock('src/integrator/utils/parametro-crypto.util', () => ({
...
describe('SeedService', () => {
  ...
  describe('cargarParametros', () => {
    ...
    it('no tumba el arranque si falta PROD_ENCRYPTION_KEY: omite el cifrado y sigue con el resto', async () => {
      const { encryptValue } = require('src/integrator/utils/parametro-crypto.util');
