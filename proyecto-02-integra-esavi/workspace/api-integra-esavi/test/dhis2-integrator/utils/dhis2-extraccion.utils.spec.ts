import { Dhis2ExtraccionUtils } from 'src/dhis2-integrator/utils/dhis2-extraccion.utils';
...
describe('Dhis2ExtraccionUtils', () => {
  const makeParametroService = (parametros: Record<string, string> = {}) =>
    ...
    } as unknown as import('src/integrator/service/parametro.service').ParametroService);
