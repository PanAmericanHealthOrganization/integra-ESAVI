...
import {AntecedenteEmbarazoController} from './antecedente-embarazo.controller';
import {AntecedenteEventoController} from './antecedente-evento.controller';
import {AntecedenteMedicoController} from './antecedente-medico.controller';
import {AntecedentePreexistenciaController} from './antecedente-preexistencia.controller';
import {DatoEsaviController} from './dato-esavi.controller';
import {DesenlaceEsaviController} from './desenlace-esavi.controller';
import {InvestigacionController} from './investigacion.controller';
import {NotificacionController} from './notificacion.controller';
import {PacienteDhis2Controller} from './paciente-dhis2.controller';
import {PacienteVigiflowController} from './paciente-vigiflow.controller';
