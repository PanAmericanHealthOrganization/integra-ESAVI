...
const findAllEtnias = async () => {
  const response = await intESAVIClient.get("integrator/etnia/findAll")
  return response.data as any[]
}

export const etniaDataProvider: DataProvider = {
  getList: async function <RecordType extends RaRecord = any>(
    _resource: string,
    params: GetListParams
  ): Promise<GetListResult<RecordType>> {
    const etnias = await findAllEtnias()
  ...
  getOne: async function <RecordType extends RaRecord = any>(
    ...
    const response = await intESAVIClient.get(`integrator/etnia/${params.id}`)
  ...
  getMany: async function <RecordType extends RaRecord = any>(
    ...
    return { data: etnias.filter((e) => ids.includes(String(e.id))) as RecordType[] }
  },
  ...
  >(
    ...
    const response = await intESAVIClient.post("integrator/etnia/create", params.data)
    return { data: response.data }
  },
  ...
  update: async function <RecordType extends RaRecord = any>(
    ...
    const response = await intESAVIClient.patch(`integrator/etnia/${params.id}`, params.data)
    return { data: response.data }
  },
  ...
  delete: async function <RecordType extends RaRecord = any>(
    ...
    const response = await intESAVIClient.delete(`integrator/etnia/${params.id}`, {
      params: { deletedBy },
    })
    return { data: response.data }
  },
