...
export class InvestigacionService 
       ...
       >{
        ...
        public async getPaginated(paginated: GetListParams): Promise<IPaginationResponse<Investigacion>> {
          ...
          if (filter?.vacunatorioCalidad !== undefined && typeof filter.vacunatorioCalidad === 'boolean') {
            buildFilter = { ...buildFilter, vacunatorioCalidad: filter.vacunatorioCalidad };
          }
          if (filter?.personalCapacitado !== undefined && typeof filter.personalCapacitado === 'boolean') {
          ...
          if (filter?.muestraLaboratorio !== undefined && typeof filter.muestraLaboratorio === 'boolean') {
         ...
         * @returns
         */
        public async delete(id: Identificator, auditoria: IBaseEntity): Promise<InvestigacionDto> {
