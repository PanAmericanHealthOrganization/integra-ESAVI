...
import { Box, Typography, Tooltip, IconButton, FilledInput, Button } from '@mui/material';
	...
	return (
		<Box mb={2} onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
			<Box mb={1} color="text.secondary">
				<ReferenceField record={note} resource="contactNotes" source="sales_id" reference="sales">
